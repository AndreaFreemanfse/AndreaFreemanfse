...
Before tech, I spent several years working in the Chicago nonprofit space. Notably I worked on programs that provided financial assistance to youth affected by gun violence. Later I transitioned to EdTech, where I found an opportunity to combine my passion for helping people with my interest in technology.
...
👥👥 Maintaied a legacy Ember.js codebase that supported 75% of the company's customer base.

📚 Championed software that made college courseware more accessible and affordable for students.

🚀 Optimize the platform to improve user accessibility.
